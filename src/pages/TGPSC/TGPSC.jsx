...
const TGPSC = () => {
  ...
  // FAQs (edit as needed)
  const faqs = [
    { q: 'What is the course duration?', a: 'The TGPSC program typically runs for X months with weekly schedules.' },
          ...
          <div className="course-hero-bg">
            <div ref={logoRef} className="appsclogo-svg">
              <div
                ...
                dangerouslySetInnerHTML={{ __html: tgpscLogoSVG }}
              />
            </div>
          </div>
          <div className="course-hero-content">
            <div className="course-header-details">
              <h1>Telangana State Public Service Commission (TGPSC)</h1>
              <p className="course-subtitle">Your gateway to success in TGPSC Group I</p>
